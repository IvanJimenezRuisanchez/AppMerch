...
const CLIENT_RESTAPI_PRODUCTSBYCATEGORIE = 'http://localhost:8081/api/productsByCategory'
class ClientService {
    ...
    getProductsByCategory(category){
        return axios.get(CLIENT_RESTAPI_PRODUCTSBYCATEGORIE,{params: {categorie: category}});
    }
}
